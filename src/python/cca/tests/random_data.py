from app_grad import OnlineAppGradCCA, BatchAppGradCCA
...
def test_online_cca_with_exp_server(X_weight, Y_weight, p1, p2):
    ...
    model = OnlineAppGradCCA(X_server, Y_server)
    
    return model.get_cca(verbose=True)

def test_online_cca_with_boxcar_server(X_window, Y_window, p1, p2):
...
def run_tests(k, reg, n, p1, p2):

    test_online_cca_with_exp_server(0.75, 0.75, p1, p2)
    test_online_cca_with_boxcar_server(10, 10, p1, p2)
