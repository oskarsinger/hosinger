...
MatrixXd RandomMatrixFactory::get_rank_k_matrix(const int m, const int n, const int k)
{
...
MatrixXd RandomMatrixFactory::get_normal_matrix(const int m, const int n)
{
