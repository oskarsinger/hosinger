...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpyrsvd(void); /*proto*/
PyMODINIT_FUNC initpyrsvd(void)
#else
PyMODINIT_FUNC PyInit_pyrsvd(void); /*proto*/
PyMODINIT_FUNC PyInit_pyrsvd(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_pyrsvd(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pyrsvd", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
